...
- 978+ 个通用代理技能
- 跨多个 AI 编码助手兼容
- 官方技能来自 Anthropic、OpenAI、Google、Microsoft、Supabase、Apify、Vercel Labs
...
| 类别 | 焦点 | 示例技能 |
|------|------|----------|
| Architecture | 系统设计、ADRs、C4 | architecture, c4-context |
| Business | 增长、定价、CRO、SEO | copywriting, pricing-strategy |
| Data & AI | LLM 应用、RAG、agents | rag-engineer, prompt-engineer |
| Development | 语言精通、框架模式 | typescript-expert, python-patterns |
| General | 规划、文档、产品运营 | brainstorming, doc-coauthoring |
| Infrastructure | DevOps、云、CI/CD | docker-expert, aws-serverless |
| Security | AppSec、pentesting | api-security-best-practices |
| Testing | TDD、测试设计、修复 | test-driven-development |
| Workflow | 自动化、编排 | workflow-automation |
...
- Webhook 服务
- 连接到 GitHub 仓库
- 通过 PR 和 Issues 提供 AI 代码协助
- @mentions 即可使用

---

### 6.4 Claude Scientific Skills (补充)
...
| Trail of Bits | 安全审计 | ⭐⭐⭐⭐ |
| Antigravity Awesome Skills | 超大规模技能集合 | ⭐⭐⭐⭐⭐ |
...
| 类别 | 推荐首选 | 平替方案 |
|------|----------|----------|
| 游戏开发 | Unity MCP | Claude Code Game Studios |
| Python 开发 | FastMCP | Claude Scientific Skills |
| 测试自动化 | Playwright MCP | Webapp Testing |
| 开发者工具 | Superpowers | AgentSys / Claude CodePro |
| 安全审计 | Trail of Bits | Security Skills |
| 大规模技能库 | Antigravity Awesome Skills | Everything Claude Code |

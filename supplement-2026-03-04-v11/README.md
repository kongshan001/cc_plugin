...
| 技能ID | 名称 | 核心能力 | 评分 |
|----------|------|---------|------|
| **web-games** | Web 游戏开发 | HTML5、WebGL、Canvas | ⭐⭐⭐⭐ |
| **3d-games** | 3D Web 游戏 | Three.js、Babylon.js | ⭐⭐⭐⭐ |
| **2d-games** | 2D Web 游戏 | Phaser、PixelJS | ⭐⭐⭐⭐ |
...
| 技能ID | 名称 | 核心能力 | 评分 |
|----------|------|---------|------|
| **mobile-games** | 移动游戏开发 | iOS、Android、性能优化 | ⭐⭐⭐⭐ |
...
| **game-design** | 游戏设计 | GDD、平衡性、玩家心理 |
| **multiplayer** | 多人游戏 | 网络同步、房间管理 |
| **game-audio** | 游戏音频 | 声音设计、动态音频 |
| **game-art** | 游戏美术 | 资产管线、动画 |
...
| **python-packaging** | Python 打包 | 发行版、依赖管理 | ⭐⭐⭐⭐ |
...
| **playwright-skill** | Playwright 技能 | 浏览器自动化 | ⭐⭐⭐⭐⭐ |
...
| 技能ID | 名称 | 核心能力 | 评分 |
|----------|------|---------|------|
| **android_ui_verification** | Android UI 测试 | uiautomator、Espresso | ⭐⭐⭐⭐ |
| **webapp-testing** | Web 应用测试 | 响应式、跨浏览器 | ⭐⭐⭐⭐ |
...
| **agent-memory-mcp** | MCP 记忆系统 | 持久化记忆 | ⭐⭐⭐⭐ |
...
| 技能ID | 名称 | 核心能力 | 评分 |
|----------|------|---------|------|
| **superpowers** | 核心开发能力 | SDLC 全流程 | ⭐⭐⭐⭐⭐ |
| **agentsys** | 工作流自动化 | PR 管理、代码审查 | ⭐⭐⭐⭐⭐ |
| **developer-tools-skills** | 开发者工具 | IDE、调试、性能 | ⭐⭐⭐⭐ |

### 4.5 AI Agent 开发

| 技能ID | 名称 | 核心能力 |
|--------|------|----------|
| **ai-agent-development** | AI Agent 开发 | Agent 架构 |
| **agent-orchestration-multi-agent-optimize** | 多 Agent 编排 | 协作、优化 |
...
- [Antigravity Skills](https://github.com/anthropics/claude-code-skills) - 970+ Claude Code 技能
- [awesome-claude-code](https://github.com/anthropiccdn/awesome-claude-code) - Claude Code 精选资源

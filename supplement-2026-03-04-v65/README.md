...
### 1.5 NVIDIA Isaac Sim MCP

> NVIDIA Isaac Sim 的自然语言控制

#### 项目信息

- **GitHub**: [omni-mcp/isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)
- **类型**: MCP 服务器

#### 核心功能

- 自然语言控制 NVIDIA Isaac Sim
- Lab、OpenUSD 控制
- 仿真和机器人开发
- 3D 场景操作
...
- **GitHub**: [ConstantineB6/comfy-pilot](https://github.com/ConstantineB6/comfy-pilot)
- **类型**: MCP 服务器
- **技术栈**: Python

#### 核心功能

- 查看、编辑、运行 ComfyUI 节点工作流
- 嵌入式终端
- AI 图像生成控制
...
### 2.7 LangGraph Agent Skill

> 使用 LangGraph 构建有状态 AI 代理和工作流

#### 项目信息

- **GitHub**: [SpillwaveSolutions/mastering-langgraph-agent-skill](https://github.com/SpillwaveSolutions/mastering-langgraph-agent-skill)
- **类型**: Claude Code Skill
- **更新**: 2026-01-07

#### 核心功能

- 使用 LangGraph 构建有状态 AI 代理
- 工具使用代理、分支工作流
- 记忆持久化
- 人机协作
- 多代理系统
...
### 2.8 Developer Kit - Java/Spring/Python/TypeScript
...
### 4.21 Token Optimizer - Token 优化工具

> 发现幽灵 Token，审计上下文窗口开销
...
> AI 编码代理的记忆系统，通过目录范围限定上下文减少 50% Token 使用
...
### 4.23 Git Context Controller

> 结构化上下文管理框架，实现 Git 式操作

#### 项目信息

- **GitHub**: [faugustdev/git-context-controller](https://github.com/faugustdev/git-context-controller)
- **类型**: Claude Code Skill

#### 核心功能

- Git 风格操作（COMMIT, BRANCH, MERGE）
- 长期代理记忆管理
...
- 海军指挥结构
- structured sailing orders, battle plans, action stations
- 船长日志管理复杂任务

---

### 4.25 Outline Driven Development

> 大纲驱动的开发方式，使用 AST 分析和现代 CLI 工具

#### 项目信息

- **GitHub**: [OutlineDriven/outline-driven-development](https://github.com/OutlineDriven/outline-driven-development)
- **类型**: Claude Code Skill
- **更新**: 2026-03-03
...
### 4.26 Media Skills - 内容创作技能

> 图像、音频、视频内容创作的开放技能集

#### 项目信息

- **GitHub**: [wells1137/media-skills](https://github.com/wells1137/media-skills)
- **类型**: Claude Code Skill
- **更新**: 2026-03-04
...
### 4.27 Cloudflare/React/Tailwind 技能

> 生产级 Claude Code CLI 技能

#### 项目信息

- **GitHub**: [secondsky/claude-skills](https://github.com/secondsky/claude-skills)
- **类型**: Claude Code Skill
- **更新**: 2026-03-03
...
| isaac-sim-mcp | NVIDIA 仿真 | - | Isaac Sim 控制 |
| blender-mcp | 3D 建模 | - | Blender 操作 |
| comfy-pilot | AI 图像 | - | ComfyUI 控制 |

**推荐**：
- Unreal 开发 → unreal-mcp
- Unity 开发 → Claude-Code-Game-Studios + Unity GameDev Skills
- 快速原型 → Godot + Claude Code
- 仿真/机器人 → isaac-sim-mcp
...
| langgraph-agent-skill | 工作流 | - | LangGraph 构建 |
| developer-kit | 多语言 | - | Java/Python/TS |
...
| token-optimizer | Token 优化 | 幽灵 Token 发现 |
| ham | 记忆系统 | 50% Token 减少 |
| nelson | 多代理 | 海军指挥结构 |
...
# Token 优化
git clone https://github.com/alexgreensh/token-optimizer ~/.claude/plugins/

# Claude Code 其他开发者工具调研 (补充)

> 2026年3月 新增热门开发者工具插件调研
...
## 16. Docker Essentials Docker 必备技能
...
```bash
# 参考 cc_skills_repo/developer-tools-skills/docker-essentials.md
```

---

## 17. Git Essentials Git 必备技能
...
```bash
# 参考 cc_skills_repo/developer-tools-skills/git-essentials.md
```

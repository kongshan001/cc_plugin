...
| 技能 | 功能 | 适用场景 |
|------|------|----------|
| react-best-practices | React 最佳实践 | Web 游戏/应用 |
| next-best-practices | Next.js 最佳实践 | 游戏官网 |
| next-cache-components | Next.js 缓存 | 性能优化 |
| next-upgrade | Next.js 升级 | 版本迁移 |
| react-native-skills | RN 开发 | 移动端游戏 |
| vercel-deploy-claimable | Vercel 部署 | 部署上线 |

### 5.3 Cloudflare 官方技能

| 技能 | 功能 | 适用场景 |
|------|------|----------|
| agents-sdk | AI Agent 开发 | 游戏后端 |
| building-mcp-server | MCP 服务器 | 服务集成 |
| durable-objects | 有状态对象 | 游戏状态 |
| web-perf | Web 性能 | 性能优化 |
| wrangler | Workers 部署 | 边缘计算 |

### 5.4 Microsoft Azure 技能

| 技能 | 功能 | 适用场景 |
|------|------|----------|
| azure-ai-agents-persistent | 持久化 AI Agent | 游戏 NPC |
| azure-ai-openai | OpenAI 集成 | AI 对话 |
| azure-cosmos | Cosmos DB | 游戏数据 |
| azure-eventhub | 事件流 | 日志/分析 |
...
| 优先级 | 技能 | 用途 | 评分 |
|--------|------|------|------|
| ⭐⭐⭐⭐⭐ | Superpowers | 核心工程技能 | 必装 |
| ⭐⭐⭐⭐⭐ | web-artifacts-builder | Web/游戏开发 | 必装 |
| ⭐⭐⭐⭐⭐ | webapp-testing | Web/游戏测试 | 必装 |
| ⭐⭐⭐⭐⭐ | MCP Builder | Python 开发 | 必装 |
| ⭐⭐⭐⭐⭐ | Connect | 应用集成 | 强烈推荐 |
| ⭐⭐⭐⭐⭐ | test-driven-development | TDD 开发 | 强烈推荐 |
| ⭐⭐⭐⭐ | Trail of Bits | 安全审计 | 推荐 |
| ⭐⭐⭐⭐ | modern-python | Python 工具链 | 推荐 |
| ⭐⭐⭐⭐ | software-architecture | 架构设计 | 推荐 |
| ⭐⭐⭐⭐ | React Native Skills | 移动端游戏 | 推荐 |
...
1. **安全审查**: 第三方技能需检查代码安全性
2. **版本兼容**: 确认 Claude Code 版本要求
3. **依赖管理**: 注意技能依赖项安装
4. **社区活跃度**: 优先选择活跃维护项目
5. **生产环境**: 生产环境使用前充分测试

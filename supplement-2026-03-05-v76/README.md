...
| 插件名称 | 方向 | Stars | 特点 |
|---------|------|-------|------|
| Claude Scientific Skills | 科学研究 | 新兴 | 研究/科学/工程 |
| Sudocode | 代理编排 | 新兴 | 轻量级/Git规范 |
| Parry | 安全工具 | 新兴 | 提示注入扫描 |
| Dippy | 效率工具 | 新兴 | Bash命令过滤 |
| Claude-Tmux | 会话管理 | 新兴 | Tmux集成 |
| Claude-ESP | 调试工具 | 新兴 | 隐藏输出流 |
...
3. **自动化测试**: Playwright 主导 (1860 Stars)，视觉测试成为新方向，TestSprite MCP 提供企业级无代码方案

4. **开发者工具**: Superpowers (4100+ Stars) 成为顶级工程技能，Lazy-Bird 和 Marketplace 提供通用能力

5. **新兴工具**: 
   - Sudocode 提供轻量级编排
   - Parry 强化安全防护
   - Dippy 解决权限疲劳
   - Claude-Tmux/ESP 改善调试体验

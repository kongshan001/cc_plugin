# Claude Code 热门插件补充调研 (v60)

> 2026年3月 游戏/Python/测试/开发者工具热门插件完整调研 - 最新热门插件深度分析
...
### 3.3 Test Master Skills

> 测试大师技能集

#### 背景需求

需要统一的测试管理技能来协调各种测试工作。
